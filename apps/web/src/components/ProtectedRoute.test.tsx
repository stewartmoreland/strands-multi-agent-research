...
describe('ProtectedRoute', () => {
  it('shows loading spinner when isLoading', () => {
    vi.mocked(useAuth).mockReturnValue(mockAuthValue({ isAuthenticated: false, isLoading: true, user: null }))
    render(
      <MemoryRouter>
        <ProtectedRoute>
  ...
  it('renders children when authenticated', () => {
    ...
    vi.mocked(useAuth).mockReturnValue(mockAuthValue({ isAuthenticated: true, isLoading: false, user }))
    render(
      <MemoryRouter>
        <ProtectedRoute>
          <span>Protected content</span>
