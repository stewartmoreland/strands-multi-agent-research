...
describe('Toast', () => {
  ...
  it('shows toast with custom duration', async () => {
    ...
    render(
      <>
        <Toaster />
        <button onClick={() => toast('Custom Duration', { duration: 5000 })}>Show Custom Duration</button>
      </>,
    )
  ...
  it('shows toast with custom className', async () => {
    ...
    render(
      <>
        ...
        <button onClick={() => toast('Custom Class Toast')}>Show Custom Class</button>
      </>,
    )
  ...
  it('shows toast with custom theme', async () => {
    ...
    render(
      <>
        <Toaster theme="dark" />
        <button onClick={() => toast('Dark Theme Toast')}>Show Dark Theme</button>
      </>,
    )
