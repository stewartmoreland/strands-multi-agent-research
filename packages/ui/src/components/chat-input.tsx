...
export interface ChatInputProps extends Omit<React.HTMLAttributes<HTMLFormElement>, 'onSubmit'> {
...
const ChatInput = React.forwardRef<HTMLFormElement, ChatInputProps>(
  ({ className, onSend, isLoading = false, placeholder = 'Type your message...', ...props }, ref) => {
    ...
    return (
      <form ref={ref} onSubmit={handleSubmit} className={cn('flex items-center gap-3', className)} {...props}>
